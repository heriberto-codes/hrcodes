...
AWS_ACCESS_KEY_ID = os.environ.get.__str__('AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = os.environ.get.__str__('AWS_SECRET_ACCESS_KEY')
AWS_STORAGE_BUCKET_NAME = os.environ.get.__str__('AWS_STORAGE_BUCKET_NAME')
