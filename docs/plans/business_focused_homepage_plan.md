...
- [ ] Add page-scoped metadata, body, stylesheet, and script extension points in `templates/base.html`; replace `templates/home.html` composition with the approved semantic section order and establish shared responsive tokens in `static/pages/home.css`.
